    ...
    dev: {
        ...
        proxyTable: {
            '/api/zuul': {
                ...
                // target: 'ttp://122.97.218.162:21018',  // 本地域名http://122.97.218.162:21018
            ...
            '/api': {
                ...
                // target: 'ttp://122.97.218.162:21018',  // 本地域名
                changeOrigin: true,  //是否跨域
                pathRewrite: {
        ...
        host: '172.16.1.92', // can be overwritten by process.env.HOST
